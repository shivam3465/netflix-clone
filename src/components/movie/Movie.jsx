  ...
  return (
    <div className='trailer-card' >
      <Link to={videoKey ? `https://www.youtube.com/watch?v=${videoKey}`:`/details/${id}`} target='_blank'>
        <img src={`https://image.tmdb.org/t/p/w500${imageLink}`} alt="" className='trailer-image'/>
...
export default function Movie() {
  ...
  useEffect(()=>{
      setLoading(()=> true);
      const fetcher= async ()=>{        
          const data1=await axios.get(`https://api.themoviedb.org/3/movie/${idNo}?api_key=0e60dc2cb3e238675effce08a8cdd770`);            
          const data2=await axios.get(`https://api.themoviedb.org/3/movie/${idNo}/images?api_key=0e60dc2cb3e238675effce08a8cdd770`);            
          const data3=await axios.get(`https://api.themoviedb.org/3/movie/${idNo}/videos?api_key=0e60dc2cb3e238675effce08a8cdd770`);            
